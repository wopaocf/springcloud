...
public interface VideoOrderMapper {
     ...
     */
      ...
      int insert (VideoOrder videoOrder);
        ...
        VideoOrder findById(@Param("order_id") Integer id);
     ...
     * @return
     */
        @Update("update video_order set del=0 where id=#{id},user_id=#{userId}")
     ...
     * @return
     */
    @Update("update video_order set state=#{state},notify_time=#{notifyTime},openid=#{openid} where out_trade_no=#{outTradeNo}" +
