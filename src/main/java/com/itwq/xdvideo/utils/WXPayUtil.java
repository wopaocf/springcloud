...
public class WXPayUtil {
     ...
     * @return
     */
    public static String createSign(SortedMap<String,String> param,String key){
     ...
     * @return
     */
    public static boolean isCorrectSign(SortedMap<String,String> param,String key){
        String sign = createSign(param, key);
        String wexinPaysign = param.get("sign").toUpperCase();
        return wexinPaysign.equals(sign);
    }
